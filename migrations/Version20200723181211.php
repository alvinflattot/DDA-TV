 ...
 */
final class Version20200723181211 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE movie (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(150) NOT NULL, slug VARCHAR(150) NOT NULL, summary VARCHAR(500) NOT NULL, type VARCHAR(40) NOT NULL, poster VARCHAR(50) NOT NULL, release_date DATETIME NOT NULL, duration INT NOT NULL, UNIQUE INDEX UNIQ_1D5EF26F989D9B62 (slug), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE serie (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(500) NOT NULL, slug VARCHAR(500) NOT NULL, type VARCHAR(40) NOT NULL, summary VARCHAR(500) NOT NULL, poster VARCHAR(50) DEFAULT NULL, start_year DATETIME NOT NULL, UNIQUE INDEX UNIQ_AA3A9334989D9B62 (slug), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
